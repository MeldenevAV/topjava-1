...
<table border=1>
    ...
    <c:forEach var="mealUnit" items="${requestScope.mealList}">
        ...
        <tr bgcolor="${mealUnit.exceed ? '#deb887':'#f0ffff'}">
            ...
            <td><a href="mealList?action=edit&mealId=<c:out value="${mealUnit.id}"/>">Update</a></td>
            <td><a href="mealList?action=delete&mealId=<c:out value="${mealUnit.id}"/>">Delete</a></td>
        </tr>
    </c:forEach>
    </tbody>
</table>
<p><a href="mealList?action=insert">Add Meal</a></p>
</body>
</html>
